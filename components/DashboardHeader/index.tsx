...
import SearchForm from "@/components/DashboardHeader/SearchForm";
...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full  shadow-solid-13 bg-white  dark:bg-black ">
      <div className="flex flex-grow items-center justify-between px-4 py-5 shadow-2 md:px-5 2xl:px-10">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <Link className="block flex-shrink-0 lg:hidden" href="/">
            <h1 className="text-neutral-900 dark:text-white text-sm">Simple <span className="text-primary font-bold">PDF</span></h1>
