...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "Audio", route: "/forms/form-elements" },
          { label: "Image", route: "/forms/form-layout" },
          { label: "Document", route: "/forms/form-elements" },
          { label: "Video", route: "/forms/form-layout" },
        ],
      },
      {
        icon: (
        ...
        children: [
          {
            label: "Video Editor",
            route: "https://online-video-cutter.com/video-editor",
          },
          {
            label: "Screen Recorder",
            route: "https://online-video-cutter.com/screen-recorder",
          },
          {
            label: "Text to Speech",
            route: "https://online-video-cutter.com/text-to-speech",
          },
          {
            label: "Merge Videos",
            route: "https://online-video-cutter.com/merge-videos",
          },
          {
            label: "Add Audio to Video",
            route: "https://online-video-cutter.com/add-music-to-video",
          },
          { label: "Trim Video", route: "https://online-video-cutter.com/" },
          {
            label: "Add Image to Video",
            route: "https://online-video-cutter.com/add-image-to-video",
          },
          {
            label: "Add Text to Video",
            route: "https://online-video-cutter.com/add-text-to-video",
          },
          {
            label: "Remove Logo from Video",
            route: "https://online-video-cutter.com/remove-logo",
          },
          {
            label: "Crop Video",
            route: "https://online-video-cutter.com/crop-video",
          },
          {
            label: "Rotate Video",
            route: "https://online-video-cutter.com/rotate-video",
          },
          {
            label: "Flip Video",
            route: "https://online-video-cutter.com/flip-video",
          },
          {
            label: "Resize Video",
            route: "https://online-video-cutter.com/resize-video",
          },
          {
            label: "Loop Video",
            route: "https://online-video-cutter.com/loop-video",
          },
          {
            label: "Change Volume",
            route: "https://online-video-cutter.com/volume",
          },
          {
            label: "Change Video Speed",
            route: "https://online-video-cutter.com/change-video-speed",
          },
          {
            label: "Stabilize Video",
            route: "https://online-video-cutter.com/stabilize-video",
          },
          { label: "Video Recorder", route: "https://webcamera.io/" },
        ],
      },
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Trim Audio", route: "https://mp3cut.net/" },
          { label: "Change Volume", route: "https://mp3cut.net/change-volume" },
          { label: "Change Speed", route: "https://mp3cut.net/change-speed" },
          { label: "Change Pitch", route: "https://mp3cut.net/change-pitch" },
          { label: "Equalizer", route: "https://mp3cut.net/equalizer" },
          { label: "Reverse Audio", route: "https://mp3cut.net/reverse-audio" },
          {
            label: "Voice Recorder",
            route: "https://online-voice-recorder.com/",
          },
          { label: "Audio Joiner", route: "https://audio-joiner.com/" },
        ],
      },
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Split", route: "https://pdf.io/split/" },
          { label: "Merge", route: "https://pdf.io/merge/" },
          { label: "Compress", route: "https://pdf.io/compress/" },
          { label: "Unlock", route: "https://pdf.io/unlock/" },
          { label: "Protect", route: "https://pdf.io/protect/" },
          { label: "Rotate", route: "https://pdf.io/rotate/" },
          { label: "Add Page Numbers", route: "https://pdf.io/page-numbers/" },
        ],
      },
      {
        icon: (
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`absolute dark:border-stroke-dark z-99999 left-0 top-0 flex h-screen w-[250px] flex-col overflow-y-hidden shadow-solid-13  bg-white dark:border-btndark dark:bg-black lg:static lg:translate-x-0 ${
          sidebarOpen
      ...
      >
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5 xl:py-10">
          <Link href="/">
            <h1 className="text-3xl text-neutral-900 dark:text-white">
              Simple <span className="font-bold text-primary">PDF</span>
            </h1>
          </Link>
        ...
        <div className="no-scrollbar z-9999 flex flex-col overflow-y-auto duration-300 ease-linear">
          {/* <!-- Sidebar Menu --> */}
